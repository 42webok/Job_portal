           ...
           <form action="{{ route('jobs.index') }}">
             <div class="row">
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                    <input type="text" class="form-control" name="keyword" id="keywords" placeholder="Keywords">
                </div>
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ Str::limit(html_entity_decode(strip_tags($job->description)), 50) }}</p>
                ...
                <div class="job_lists">
                    <div class="row">
                     ...
                     @if($latestJobs->count() > 0)
                        ...
                        @endforeach
                        @else
                            <h4>No latest jobs available.</h4>
                        @endif
