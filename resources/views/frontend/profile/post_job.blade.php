...
<section class="section-5 bg-2">
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                   <form action="{{ route('save_job_data') }}" method="post">
                    @csrf
                    ...
                    <div class="card-body card-form p-4">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select @error('job_type') is-invalid @enderror" name="job_type" id="job_type">
                                    ...
                                    @foreach($job_types as $job_type)
                                        <option value="{{ $job_type->id }}" {{ old('job_type') == $job_type->id ? 'selected' : '' }}>{{ $job_type->name }}</option>
                                    @endforeach
                                </select>
                                @error('job_type')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row">
                            <div class="mb-4 col-md-6">
                                ...
                                <input type="text" value="{{ old('salary') }}" placeholder="Salary" id="salary" name="salary" class="form-control @error('salary') is-invalid @enderror">
                                @error('salary')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-4 col-md-6">
                                ...
                                <input type="text" value="{{ old('company_name') }}" placeholder="Company Name" id="company_name" name="company_name" class="form-control @error('company_name') is-invalid @enderror">
                                @error('company_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" value="{{ old('company_website') }}" placeholder="Website" id="website" name="company_website" class="form-control">
                        </div>
                    </div> 
